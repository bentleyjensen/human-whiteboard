...
exports.pages.draw = function anonymous(locals) {
    var buf = [];
    with (locals || {}) {
        buf.push('<section class="page pageThree"><style>#makeCanvas{border:1px solid black;width:100%;height:88%;} .full{ height:100%; width:100%}\n</style><script>src="./blah.js"</script><div class="full"><canvas id="makeCanvas" class="full"></canvas></div><div class="buttons"><input id="dotSize" class="input"/><button class="btn size">Go</button><button class="btn erase">Erase</button><button class="btn bigger">Bigger</button><button class="btn smaller">Smaller</button><button class="btn color">New Color</button></div></section>');
    }
    return buf.join("");
};
